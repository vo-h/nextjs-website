...
function airtableEmbed(url) {
  ...
  return `<iframe class="airtable-embed" src="${url}?backgroundColor=blue&viewControls=on" frameborder="0" onmousewheel="" width="100%" height="533" style="background: transparent; border: 1px solid #ccc;"></iframe>`
}
